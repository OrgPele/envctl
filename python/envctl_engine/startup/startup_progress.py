...
class ProjectSpinnerGroup:
    ...
    def __enter__(self) -> "ProjectSpinnerGroup":
        ...
        try:
            ...
            self._emit_lifecycle("start", f"Starting {len(self._projects)} project(s)...")
        except Exception:
            self._enabled = False
        return self
