...
def _selected_default_services_have_no_local_system(
    runtime: object,
    context: ProjectContextLike,
    *,
    mode: str,
...
def _record_no_local_system_skip(
    runtime: object,
    context: ProjectContextLike,
    *,
    mode: str,
...
def start_project_services(
    ...
    *,
    ...
    if not selected_service_types:
        ...
        return {}
    if _selected_default_services_have_no_local_system(
        rt,
        context,
        mode=effective_mode,
        route=route,
