...
from envctl_engine.startup.service_no_system_support import skip_unconfigured_services
...
def start_project_services(
    ...
    *,
    ...
    if skip_unconfigured_services(
        rt, context, effective_mode, route, selected_service_types, configured_additional_services
    ):
        return {}
