...
from envctl_engine.startup.service_execution_no_system import skip_default_no_system_services
...
def start_project_services(
    ...
    *,
    ...
    if not selected_service_types:
        ...
        return {}
    ports = (backend_plan.final, frontend_plan.final)
    if skip_default_no_system_services(rt, context, effective_mode, route, selected_service_types, ports):
        return {}
