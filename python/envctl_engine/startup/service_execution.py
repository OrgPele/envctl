...
from envctl_engine.startup.no_system_config import skip_no_local_app_system_services
...
def start_project_services(
    ...
    *,
    ...
    if route is not None:
        dependency_emitter = make_service_dependency_emitter(orchestrator=orchestrator, runtime=rt, route=route)
        route.flags.setdefault("emit_service_dependency", dependency_emitter)
    ...
    if not selected_service_types:
        ...
        return {}
    if skip_no_local_app_system_services(orchestrator, context, route, effective_mode, selected_service_types):
        return {}
