...
from envctl_engine.startup.service_launch_models import LaunchedServiceRuntime, PreparedServiceLaunch
from envctl_engine.startup.service_no_system import (
    record_no_local_app_system_skip,
    should_skip_no_local_app_system,
)
...
def start_project_services(
    ...
    *,
    ...
    if not selected_service_types:
        ...
        return {}
    if should_skip_no_local_app_system(
        rt,
        context=context,
        route=route,
        mode=effective_mode,
