...
class StartupRuntime(Protocol):
    ...
    def _load_auto_resume_state(self, runtime_mode: str) -> object | None: ...
    ...
    def _write_artifacts(self, state: RunState, contexts: list[ProjectContextLike], *, errors: list[str]) -> None: ...
    def _print_summary(self, state: RunState, contexts: list[ProjectContextLike]) -> None: ...
