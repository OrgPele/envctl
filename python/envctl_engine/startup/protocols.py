...
class StartupRuntime(Protocol):
    ...
    def _reserve_project_ports(self, context: ProjectContextLike, route: Route | None = None) -> None: ...
    ...
    def _contexts_from_raw_projects(self, raw_projects: list[tuple[str, Path]]) -> list[ProjectContextLike]: ...
