...
FailureHeadlineBuilder = Callable[[str], str]
...
def migrate_result_records(
    *,
    ...
    failure_headline: FailureHeadlineBuilder | None = None,
    ...
    for project_name_raw in project_names:
        ...
        record = migrate_result_record(
            ...
            failure_headline=failure_headline,
        )
...
def migrate_result_record(
    *,
    ...
    if not headline and summary and failure_headline is not None:
        headline = failure_headline(summary)
    hint_lines: list[str] = []
