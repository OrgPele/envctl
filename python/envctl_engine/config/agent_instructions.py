...
def _envctl_workflow_section() -> AgentInstructionSection:
    return AgentInstructionSection(
        ...
        body=(
            ...
            "- Fall back to `envctl ship -m \"<message>\"` only when the combined command "
            "is unavailable or returns actionable fallback instructions. Both use the ship workflow: "
