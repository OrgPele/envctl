...
def _serena_section() -> AgentInstructionSection:
    return AgentInstructionSection(
        ...
        body=(
            ...
            "keys, log messages, config values, and docs prose.\n"
...
def _envctl_workflow_section() -> AgentInstructionSection:
    return AgentInstructionSection(
        ...
        body=(
            ...
            "for the final tree, use `envctl test-focused --ship-on-pass \"<message>\"` "
            "from inside the current worktree as the single envctl local validation-and-handoff "
            ...
            "- Fall back to `envctl ship -m \"<message>\"` when the combined command "
            "is unavailable, returns actionable fallback instructions, or focused validation "
            "already passed for the final tree. Both use the ship workflow: "
            ...
            "handoff commands only when `ship` is unavailable.\n"
