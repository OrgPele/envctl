...
COMMAND_HELP_TOPICS: dict[str, CommandHelpTopic] = {
    ...
    "plan": CommandHelpTopic(
        ...
        usage=(
            "envctl --plan <selector> [--headless] [--dry-run] [--cmux|--tmux|--omx] [--codex|--opencode] [--new-worktree|--fresh-session]",
        ...
        flags=(
            ...
            "--cmux              envctl opens a cmux surface and submits the workflow there",
        ...
        examples=(
            ...
            "envctl --plan feature/task --cmux --new-worktree",
