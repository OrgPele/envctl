...
ACTIONS_HELP_TOPICS: dict[str, CommandHelpTopic] = {
    ...
    "test-focused": CommandHelpTopic(
        ...
        what_it_does=(
            ...
            "runs pytest commands single-threaded by default; use --test-parallel to opt into pytest-xdist",
        ...
        flags=(
            ...
            "--test-parallel         opt into pytest-xdist auto-injection for this run",
            "--test-parallel-max <n> cap pytest-xdist workers when enabled",
            "--no-test-parallel      force single-threaded pytest commands for this run",
