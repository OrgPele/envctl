...
ACTIONS_HELP_TOPICS: dict[str, CommandHelpTopic] = {
    "test": CommandHelpTopic(
        ...
        what_it_does=(
            ...
            "runs multiple suites in parallel by default with a CPU-aware cap and sequential fallback",
            "keeps pytest-xdist disabled unless a pytest-specific env/config opt-in is set",
        ),
        flags=(
            ...
            "--parallel / --sequential            choose suite parallelism",
            "--test-parallel-max <n>              cap suite concurrency and pytest-xdist workers when enabled",
    ...
    "test-focused": CommandHelpTopic(
        ...
        what_it_does=(
            ...
            "runs pytest commands single-threaded by default; use --parallel or set "
            "ENVCTL_TEST_FOCUSED_PYTEST_PARALLEL=true to opt into pytest-xdist",
        ...
        flags=(
            ...
            "--parallel              opt into pytest-xdist auto-injection for this run",
            "--test-parallel-max <n> cap pytest-xdist workers when enabled",
            "--sequential            force single-threaded pytest commands for this run",
