...
def run_action_command(runtime: Any, route: Route) -> int:
    return runtime.action_command_orchestrator.execute(route)


def resolve_action_targets(runtime: Any, route: Route, *, trees_only: bool) -> tuple[list[object], str | None]:
...
def run_delete_worktree_action(runtime: Any, route: Route) -> int:
