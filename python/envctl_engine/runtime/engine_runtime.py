...
class PythonEngineRuntime:
    ...
    def _run_test_action(self, route: Route, targets: list[ProjectContext]) -> int:
        return runtime_run_test_action(self, route, targets)  # type: ignore[arg-type]

    def _run_pr_action(self, route: Route, targets: list[ProjectContext]) -> int:
        return runtime_run_pr_action(self, route, targets)  # type: ignore[arg-type]

    def _run_commit_action(self, route: Route, targets: list[ProjectContext]) -> int:
        return runtime_run_commit_action(self, route, targets)  # type: ignore[arg-type]

    def _run_analyze_action(self, route: Route, targets: list[ProjectContext]) -> int:
        return runtime_run_analyze_action(self, route, targets)  # type: ignore[arg-type]

    def _run_migrate_action(self, route: Route, targets: list[ProjectContext]) -> int:
        return runtime_run_migrate_action(self, route, targets)  # type: ignore[arg-type]
    ...
    def _action_env(
        ...
        *,
        ...
        return runtime_action_env(self, command_name, targets, target=target, extra=extra)
