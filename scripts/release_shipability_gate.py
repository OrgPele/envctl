...
def main(argv: list[str] | None = None) -> int:
    ...
    tests_group.add_argument("--check-tests", dest="check_tests", action="store_true", help="Run the Python unittest suite as part of the gate.")
    tests_group.add_argument("--skip-tests", dest="check_tests", action="store_false", help="Skip Python unittest execution during gate evaluation.")
