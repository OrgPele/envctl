...
class ConfigPersistenceTests(unittest.TestCase):
    ...
    def test_ignore_local_config_updates_configured_global_excludes_only(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn(".codegraph/", excludes_text)
            self.assertIn(".serena/project.local.yml", excludes_text)
    ...
    def test_ignore_local_config_is_idempotent(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(exclude_lines.count(".codegraph/"), 1)
            self.assertEqual(exclude_lines.count(".serena/project.local.yml"), 1)
