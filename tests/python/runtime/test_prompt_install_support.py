...
class PromptInstallSupportTests(unittest.TestCase):
    ...
    def test_renderers_produce_expected_target_shapes(self) -> None:
        ...
        self.assertIn("returns GitHub status-check state", codex)
        ...
        self.assertIn("run `envctl test-plan --project <current-worktree-name> --json`", finalize_prompt.body)
        ...
        self.assertIn("commit, push, create or reuse the PR, and report status checks", finalize_prompt.body)
