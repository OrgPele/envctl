...
- Locks the generated launch commands for each surface:
  - Codex: `ENVCTL_PLAN_AGENT_CODEX_CYCLES=<n> envctl --plan <selector> --tmux --headless --new-session`
  - OpenCode/ULW: `envctl --plan <selector> --tmux --opencode --ulw --headless --new-session`
  - OMX/Ralph: `envctl --plan <selector> --omx --ralph --headless --new-session`
