...
| `ENVCTL_SHIP_PR_LABEL` | `envctl-shipped` | Label name applied when `ENVCTL_SHIP_PR_LABEL_ENABLE=true`. Blank disables label application even when the feature flag is enabled. |
