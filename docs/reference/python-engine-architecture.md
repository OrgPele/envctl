...
| Planning and generated worktrees | `python/envctl_engine/planning/worktree_domain.py` and `python/envctl_engine/planning/worktree_orchestrator.py` | `planning/menu.py`, `planning/worktree_code_intelligence.py`, `planning/worktree_provenance.py`, `planning/worktree_git_hooks.py`, `planning/worktree_main_task.py`, `planning/worktree_selection_memory.py` | Public worktree setup helpers keep current behavior while implementation moves behind owners. |
