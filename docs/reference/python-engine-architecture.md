...
| Action commands | `python/envctl_engine/actions/action_command_orchestrator.py`, `python/envctl_engine/actions/action_*`, `python/envctl_engine/actions/project_action_domain.py` | `test`, `pr`, `commit`, `review`, `migrate`, worktree action behavior and summaries |
