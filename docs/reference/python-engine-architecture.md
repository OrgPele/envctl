...
| Action commands | `python/envctl_engine/actions/action_command_orchestrator.py` | `actions/action_target_support.py`, `actions/action_test_runner.py`, `actions/action_worktree_runner.py`, `actions/project_action_domain.py` | Action command output, worktree safety checks, artifacts, and return codes remain compatible. |
