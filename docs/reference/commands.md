...
- in that queued PR follow-up and in `finalize_task`, the intended PR behavior is open/edit the PR title/body, not post a PR comment or PR review comment unless the user explicitly asks for one
