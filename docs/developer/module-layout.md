...
- Migrate action result records, summary rendering, shared hint compaction, migration failure log display, and migrate status symbols belong in `python/envctl_engine/actions/action_migrate_results.py`.
