...
- the installed implementation-oriented presets tell agents to pass commit messages inline with `envctl ship -m "<message>"` and not to maintain envctl-local commit-message ledger files
